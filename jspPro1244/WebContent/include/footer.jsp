      ...
      <div class="row">
         ...
         <div class="col-sm-2"><h4 style="text-align: center;">뭘 넣지</h4>
            <div class="list-group">
               <a href="../travel/shop.jsp" class="list-group-item">쇼핑하기</a>
               <a href="../board/index.jsp" class="list-group-item">정보게시판</a>
               <a href="#" class="list-group-item">회사정보</a>            
            </div>
         </div>
         <div class="col-sm-2"><h4 style="text-align: center;">SNS</h4>
            <div class="list-group">
               ...
               <a href="#" class="list-group-item">싸이월드</a>            
            </div>
         </div>
