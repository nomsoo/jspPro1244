...
<nav class="navbar navbar-default">
   <div class="container-fluid">
      <div class="navbar-header">
         ...
         <a class="navbar-brand" href="../travel/main.jsp">MY TRAVEL</a>         
      </div>
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
         <li class="active"><a onclick="log()">여행정보<span class="sr-only"></span></a></li>
         <li><a href="#">회사정보</a></li>
         <li class="dropdown">
            ...
            <ul class="dropdown-menu">
               <li><a onclick="log()">추천상품</a>
               <li><a onclick="log()">전자기기</a>
               <li><a onclick="log()">생활용품</a>
            </ul>
         </li>
         <li><a onclick="log()">정보게시판</a></li>
      </ul>
      <form class="navbar-form navbar-left">
         <div class="form-group">
            <input type="text" class="form-control" placeholder="내용을 입력하세요.">
         </div>
         <button onclick="log()" class="btn btn-default" >검색</button>      
       </form>
