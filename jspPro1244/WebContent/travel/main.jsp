...
<%@ include file="../include/logheader.jsp" %>
...
<body>
<div class="container">
  <div class="jumbotron" style="color: white; background-color: block;">
   <h1 class="text-center" >즐거운 여행을 추구합니다.</h1>
   <p class="text-center">MY TRAVEL는 즐겁고 편한한 여행을 추구합니다. 여행자에게 최고의 시간을 선물하겠습니다.</p>
   <p class="text-center"><a class="btn btn-primary btn-lg" onclick="log()" role="button">여행지둘러보기</a>  
  </div>
  <div class="row">
  	 <div class="col-md-12">
...
<%@ include file="../include/logfooter.jsp" %>
</body>
</html>